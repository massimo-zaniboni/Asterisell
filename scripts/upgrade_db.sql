...
ALTER TABLE `cdr` DROP KEY `cdr_channel_index`, DROP KEY `cdr_income_ar_rate_id_index`, DROP KEY `cdr_income_index`, DROP KEY `cdr_cost_ar_rate_id_index`, DROP KEY `cdr_vendor_id_index`, DROP `cdr_cost_index`, DROP KEY `cdr_cached_internal_telephone_number_index`, DROP KEY `cdr_cached_external_telephone_number_index`, DROP KEY `cdr_external_telephone_number_with_applied_portability_index`, DROP KEY `cdr_cached_masked_external_telephone_number_index`;
