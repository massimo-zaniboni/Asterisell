...
abstract class BaseArRatePeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'ar_rate';
	...
	const AR_RATE_CATEGORY_ID = 'ar_rate.AR_RATE_CATEGORY_ID';

	
	const AR_PARTY_ID = 'ar_rate.AR_PARTY_ID';

	
	const START_TIME = 'ar_rate.START_TIME';

	
	const END_TIME = 'ar_rate.END_TIME';

	
	const PHP_CLASS_SERIALIZATION = 'ar_rate.PHP_CLASS_SERIALIZATION';

	
	const USER_INPUT = 'ar_rate.USER_INPUT';

	
	const NOTE = 'ar_rate.NOTE';
	...
	{
		include_once 'lib/model/map/ArRateMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.ArRateMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = ArRatePeer::getTableMap();
	...
	{
		return str_replace(ArRatePeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ArRatePeer::AR_RATE_CATEGORY_ID);

		$criteria->addSelectColumn(ArRatePeer::AR_PARTY_ID);

		$criteria->addSelectColumn(ArRatePeer::START_TIME);

		$criteria->addSelectColumn(ArRatePeer::END_TIME);

		$criteria->addSelectColumn(ArRatePeer::PHP_CLASS_SERIALIZATION);

		$criteria->addSelectColumn(ArRatePeer::USER_INPUT);

		$criteria->addSelectColumn(ArRatePeer::NOTE);

	}

	const COUNT = 'COUNT(ar_rate.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT ar_rate.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(ArRatePeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(ArRatePeer::COUNT);
		}
		...
		$rs = ArRatePeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ArRatePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ArRatePeer::populateObjects(ArRatePeer::doSelectRS($criteria, $con));
	}
	...
	public static function doCountJoinArRateCategory(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ArRatePeer::AR_RATE_CATEGORY_ID, ArRateCategoryPeer::ID);
	...
	public static function doCountJoinArParty(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ArRatePeer::AR_PARTY_ID, ArPartyPeer::ID);
	...
	public static function doSelectJoinArRateCategory(Criteria $c, $con = null)
	{
		...
		$startcol = (ArRatePeer::NUM_COLUMNS - ArRatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		ArRateCategoryPeer::addSelectColumns($c);

		$c->addJoin(ArRatePeer::AR_RATE_CATEGORY_ID, ArRateCategoryPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getArRateCategory(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addArRate($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initArRates();
	...
	public static function doSelectJoinArParty(Criteria $c, $con = null)
	{
		...
		$c->addJoin(ArRatePeer::AR_PARTY_ID, ArPartyPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ArRatePeer::addSelectColumns($c);
		$startcol2 = (ArRatePeer::NUM_COLUMNS - ArRatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getArParty(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addArRate($obj1); 					break;
				}
			}
	...
	{
		return ArRatePeer::CLASS_DEFAULT;
	}
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ArRatePeer::ID);
			$selectCriteria->add(ArRatePeer::ID, $criteria->remove(ArRatePeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(ArRatePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof ArRate) {

			$criteria = $values->buildPkeyCriteria();
		} else {
						$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(ArRatePeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function doValidate(ArRate $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ArRatePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ArRatePeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(ArRatePeer::DATABASE_NAME, ArRatePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = ArRatePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(ArRatePeer::ID, $pk);


		$v = ArRatePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(ArRatePeer::ID, $pks, Criteria::IN);
			$objs = ArRatePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
...
if (Propel::isInit()) {
			try {
		BaseArRatePeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			require_once 'lib/model/map/ArRateMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.ArRateMapBuilder');
}
