...
abstract class BaseArDocumentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ArPartyId', 'DocumentName', 'DocumentDate', 'Document', 'MimeType', ),
		BasePeer::TYPE_COLNAME => array (ArDocumentPeer::ID, ArDocumentPeer::AR_PARTY_ID, ArDocumentPeer::DOCUMENT_NAME, ArDocumentPeer::DOCUMENT_DATE, ArDocumentPeer::DOCUMENT, ArDocumentPeer::MIME_TYPE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ar_party_id', 'document_name', 'document_date', 'document', 'mime_type', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ArPartyId' => 1, 'DocumentName' => 2, 'DocumentDate' => 3, 'Document' => 4, 'MimeType' => 5, ),
		BasePeer::TYPE_COLNAME => array (ArDocumentPeer::ID => 0, ArDocumentPeer::AR_PARTY_ID => 1, ArDocumentPeer::DOCUMENT_NAME => 2, ArDocumentPeer::DOCUMENT_DATE => 3, ArDocumentPeer::DOCUMENT => 4, ArDocumentPeer::MIME_TYPE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ar_party_id' => 1, 'document_name' => 2, 'document_date' => 3, 'document' => 4, 'mime_type' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
