...
class CdrMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('SOURCE_ID', 'SourceId', 'string', CreoleTypes::VARCHAR, false, 1024);
		...
		$tMap->addColumn('SOURCE_DATA', 'SourceData', 'string', CreoleTypes::LONGVARCHAR, false, null);
