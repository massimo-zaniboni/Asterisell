...
class ArParamsMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('SERVICE_NAME', 'ServiceName', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('SERVICE_PROVIDER_WEBSITE', 'ServiceProviderWebsite', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('SERVICE_PROVIDER_EMAIL', 'ServiceProviderEmail', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('VAT_TAX_PERC', 'VatTaxPerc', 'int', CreoleTypes::INTEGER, true, 20);

		$tMap->addColumn('LOGO_IMAGE', 'LogoImage', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('SLOGAN', 'Slogan', 'string', CreoleTypes::VARCHAR, false, 1024);

		$tMap->addColumn('LOGO_IMAGE_IN_INVOICES', 'LogoImageInInvoices', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('FOOTER', 'Footer', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('USER_MESSAGE', 'UserMessage', 'string', CreoleTypes::VARCHAR, false, 255);
		...
		$tMap->addColumn('LEGAL_WEBSITE', 'LegalWebsite', 'string', CreoleTypes::VARCHAR, false, 255);
		...
		$tMap->addColumn('LEGAL_EMAIL', 'LegalEmail', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('LEGAL_PHONE', 'LegalPhone', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('PHONE2', 'Phone2', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('LEGAL_FAX', 'LegalFax', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('INVOICE_NOTES', 'InvoiceNotes', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('INVOICE_PAYMENT_TERMS', 'InvoicePaymentTerms', 'string', CreoleTypes::VARCHAR, false, 2048);

		$tMap->addColumn('SENDER_NAME_ON_INVOICING_EMAILS', 'SenderNameOnInvoicingEmails', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('INVOICING_EMAIL_ADDRESS', 'InvoicingEmailAddress', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('ACCOUNTANT_EMAIL_ADDRESS', 'AccountantEmailAddress', 'string', CreoleTypes::VARCHAR, false, 255);
		...
		$tMap->addColumn('SMTP_USERNAME', 'SmtpUsername', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('SMTP_PASSWORD', 'SmtpPassword', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('SMTP_ENCRYPTION', 'SmtpEncryption', 'string', CreoleTypes::VARCHAR, false, 255);
