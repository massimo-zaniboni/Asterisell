...
include_partial('admin_tt_call_report/list_header');
include_partial('admin_tt_call_report/list_messages');
...
include_partial('admin_tt_call_report/list');

echo '</div>';

echo '<div id="sf_admin_footer">';

include_partial('admin_tt_call_report/list_footer');
