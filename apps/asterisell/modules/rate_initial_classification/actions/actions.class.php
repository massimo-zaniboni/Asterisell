 ...
 */
class rate_initial_classificationActions extends autoRate_initial_classificationActions
{
  ...
  public function updatePhpRateWithFormFields(PhpRate $phpRate) {
    ...
    $phpRate->dstChannel = $this->getRequest()->getParameter('dst_channel');
    $phpRate->disposition = $this->getRequest()->getParameter('disposition');
    $phpRate->amaflags = $this->getRequest()->getParameter('amaflags');
    $phpRate->destinationType = $this->getRequest()->getParameter('destination_type');
  ...
  public function handleErrorSave() {
    $this->redirect('rate_initial_classification/edit?id=' . VariableFrame::$arRate->getId());
  }
